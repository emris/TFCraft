...
import TFC.Core.RailLogic;
import TFC.TileEntities.TileEntityNULL;

public class BlockCustomRail extends BlockContainer
{
	public BlockCustomRail(int par1, boolean par2) {
		...
		this.func_111022_d("rail_normal");
	}
    ...
    {
        return true; //Block.blocksList[par0] instanceof BlockRailBase;
    }
    ...
    {
//        if (par7 > 0 && Block.blocksList[par7].canProvidePower() && (new RailLogic(this, par1World, par2, par3, par4)).getNumberOfAdjacentTracks() == 3)
//        {
...
//        }
    ...
    protected void refreshTrackShape(World par1World, int par2, int par3, int par4, boolean par5)
    {
        if (!par1World.isRemote)
        {
//            (new RailLogic(this, par1World, par2, par3, par4)).func_94511_a(par1World.isBlockIndirectlyGettingPowered(par2, par3, par4), par5);
        }
    }
